<template>
    <div id="toc">
        <div
            class="toc-item text-sm border-l-2 hover:bg-theme-card border-theme-base hover:border-theme-primary hover:text-theme-primary hover:px-6 p-1 pl-4 select-none cursor-pointer"
            v-for="(item, i) in toc"
            :key="i">
